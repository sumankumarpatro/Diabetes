...
class LLMInterface:
    ...
    async def generate_structured_json(self, prompt: str, schema: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        and performs a clean, structured extraction.
        """
        try:
            ...
            # If the async provider returned a raw string, parse it using our parser engine
    ...
    def _parse_json_payload(self, text: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            # Clean out markdown code boundaries
