...
def print_beautified_metrics(mode: str, metrics: dict, report: str):
    """Prints an ultra-clean summary dashboard to the terminal."""
    border = "=" * 65
    sub_border = "-" * 65
...
def evaluate_model(data_path: str, model_payload_path: str, mode: str):
    ...
    logger.info("Running hardware-accelerated test inference...")
    ...
    print_beautified_metrics(mode, metrics_payload, native_report)
